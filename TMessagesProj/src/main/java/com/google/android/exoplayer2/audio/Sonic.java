 ...
 */
// Made public so the voice changer can pitch shift the microphone stream; the class is otherwise
// untouched from upstream, where it is package private because only SonicAudioProcessor used it.
